...
INCLUDE_PATHS = -Iinclude -IF:/Skola/CPROG/msys64/mingw64/include

# Mac LIBRARY_PATHS!
#LIBRARY_PATHS = -Llib -L/usr/local/lib
# Windows LIBRARY_PATHS
#LIBRARY_PATHS = -Llib -LF:\Skola\CPROG\SDL2\lib\x64
LIBRARY_PATHS = -Llib -LF:/Skola/CPROG/msys64/mingw64/lib
